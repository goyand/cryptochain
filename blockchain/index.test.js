...
describe("Blockchain", () => {
    ...
    describe('isValidChain()', () => {
        ...
        describe('when the chain starts with the genesis block and has multiple blocks', () => {
            beforeEach(() => {
                ...
                blockchain.addBlock({ data: "Battlestar Glactica"});
            })
            ...
            describe('and the chanin contains a block with a jumped difficulty', () => {
                it('returns false', () => {
                    ...
                    const badBlock = new Block({
                        timestamp, lastHash, nonce, hash, data, difficulty
                    });
    ...
    describe('validTransactionData()', () => {
        ...
        describe('and the transaction data has at least one malformed outputMap', () => {
            ...
            describe('and the transaciton is a reward transaction', () => {
                it('returns false and logs an error', () => {
